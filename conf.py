...
#               "white_only" (only picture of white people)
#               "poc_between_whites" (expression picture poc, others white people)
#               "white_between_poc" (expression picture white people, others poc)
